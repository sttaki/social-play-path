...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-smooth focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "border-transparent gradient-primary text-primary-foreground hover:scale-110",
        secondary:
          "border-transparent gradient-card text-secondary-foreground hover:bg-secondary/80 hover:scale-110",
        destructive:
          "border-transparent bg-destructive text-destructive-foreground hover:bg-destructive/80 hover:scale-110",
        outline: "text-foreground border-border hover:scale-110",
      },
    },
    defaultVariants: {
      variant: "default",
